// @chirag127/astro-data
export const __pkg = '@chirag127/astro-data' as const

// Family site catalogue — single source of truth for cross-site links.
// Consolidates 9 previously-vendored copies of family.ts across the oriz apps.
...
// Re-export convenience alias for older consumers
export type { FamilySite as Site }
